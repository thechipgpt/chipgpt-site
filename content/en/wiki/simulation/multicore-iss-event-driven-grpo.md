...
Переход от SystemC TLM к специализированной Event-Driven архитектуре — не просто оптимизация производительности, а архитектурное требование для применения GRPO к многоядерным матрицам. Глобальная функция вознаграждения, оценивающая состояние всей системы, предъявляет жёсткие требования к симулятору (минимальные задержки синхронизации) и к алгоритму обучения (необходимость использования выразительных архитектур политик, таких как GNN, и точных механизмов распределения кредита между агентами). Предложенный поэтапный план обеспечивает плавное масштабирование сложности, сохраняя устойчивость обучения и гарантируя, что каждое ядро в итоговой эмуляции GPU/TPU будет функционировать как элемент согласованного, самооптимизирующегося ансамбля.
