...
|:---|:---|:---|
| **Основная функция** | Ускоритель и оптимизатор поиска; помощник дизайнера | Стратегический руководитель и генератор идей; ««REASONING-DRIVEN» |
...
| **Тип задач** | Операционная оптимизация (хорошо поставленная задача) | Стратегическое планирование и открытие (плохо поставленная задача) |
