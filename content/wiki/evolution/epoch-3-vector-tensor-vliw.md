...
│        L1 Data Memory           │
├─────────────────────────────────┤
│  Mode: CACHE  │  Mode: SCRATCHPAD │
├─────────────────────────────────┤
│ • Аппаратный контроллер         │ • Программное управление      │
│ • Алгоритмы замещения (LRU)     │ • Прямые load/store-инструкции│
│ • Непредсказуемые промахи       │ • Детерминированный доступ    │
│ • Удобно для общего кода        │ • Идеально для VLIW-циклов   │
└─────────────────────────────────┘
```
