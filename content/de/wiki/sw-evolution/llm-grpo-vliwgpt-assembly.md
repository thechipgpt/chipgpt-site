...
**Ключевой принцип:** Компилятор, ISA и веса LLM эволюционируют в едином замкнутом цикле. Аппаратное расширение ISA автоматически генерирует новые `.td` описания, которые подаются в LLM как RAG-контекст, а GRPO-агент обучается их эффективной упаковке в бандлы.
...
## 🌳 Поиск по дереву и мелкозернистая оптимизация (FGO)
